...
> See `DOCUMENT_PROCESSING_DESIGN.md` → Task S.1 for the writer implementation.
>
...
`DOCUMENT_PROCESSING_DESIGN.md`); this pipeline reads it. Change detection is based on
...
`DOCUMENT_PROCESSING_DESIGN.md` Part B (B.2 and B.3) — these are shared across both
pipelines.
