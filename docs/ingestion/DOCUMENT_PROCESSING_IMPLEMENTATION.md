...
- Task 1.1 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task 1.2 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task 1.3 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task 1.4 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task 1.5 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- `PipelineConfig` dataclass from `src/ingest/pipeline_types.py` (Phase 0)
- `build_document_processing_graph` signature from `src/ingest/pipeline_workflow.py` (Phase 0 stub)
- Task 1.11 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task S.1 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task 2.3 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- Task 3.1 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
- `document_ingestion_node` signature from `src/ingest/nodes/document_ingestion.py` (Phase 0 stub)
- Task 3.5 description and subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 1.1 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 1.2 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 1.3 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 1.4 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 1.5 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 1.11 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task S.1 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 2.3 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 3.1 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
...
**Agent input:**
- Task 3.5 description + subtasks from `DOCUMENT_PROCESSING_DESIGN.md`
